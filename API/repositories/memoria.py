...
class SimulacionEnMemoria(SimulationRepository):
    """Implementacion en memoria de SimulationRepository (dict)."""
    def __init__(self) -> None:
        self._datos: dict[str, Simulacion] = {}   # dict {id: Simulacion}

    def guardar(self, sim: Simulacion) -> None:
        self._datos[sim.id] = sim                 # upsert por id
    ...
    def eliminar(self, id_sim: str) -> None:
        self._datos.pop(id_sim, None)             # elimina si existe, sino silencioso
